...
default_coeff_fn = os.path.abspath(os.path.join(basepath,'coefficients','SW_OPER_EIO_SHA_2E_00000000T000000_99999999T999999_0401.txt')) # Update with data through 2025-10, inclusive
